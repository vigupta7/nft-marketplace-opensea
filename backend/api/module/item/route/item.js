...
router.post('/resale', [check('price').not().isEmpty(), check('item_id').not().isEmpty(), auth], itemController.resale)
router.post('/resale-information', [check('item_id').not().isEmpty(), auth], itemController.resaleInformation)
...
router.post('/buy-request', [check('item_id').not().isEmpty(), auth], itemController.buyRequest)
router.post('/buy-request-update', [check('buy_request_id').not().isEmpty(), auth], itemController.buyRequestUpdate)
